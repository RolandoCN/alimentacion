    ...
    <div style="margin-bottom:30px; margin-top:12px;">
        ...
        <table class="ltable" style="" border="0" width="100%" style="padding-bottom:2px !important">
            ...
            <tr style="font-size: 11px"  class="fuenteSubtitulo " style=""> 
                <th colspan="11" style="border-color:white;height:35px;text-align: center;border:0 px" width="100%"  >ALIMENTACIÓN EXTRA <br>
        ...
        <div style="margin-top:12px;">
            <table class="ltable"  border="0" width="100%" style="padding-bottom:2px !important">
                ...
                <tr style="font-size: 10px !important; background-color: #D3D3D3;line-height:10px; "> 
                    ...
                    <th width="20%" style="border: 0px; ;border-color: #D3D3D3; text-align: center">FUNCIONARIO</th>

                    <th width="25%" style="border-right: 0px;border-top: 0px; border-bottom:0px;border-color: #D3D3D3; text-align: center">PUESTO</th>
                
                    <th width="10%" style="border: 0px; text-align: center">ALIMENTO</th>

                    <th width="25%" style="border: 0px; text-align: center">MOTIVO</th>
        ...
        <p style="font-size: 10px; text-align:center; font-family:sans-serif;"><b  style="font-size: 10px;">TOTAL: {{sizeof($lista_datos)}}</b></p>
