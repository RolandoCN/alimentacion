        ...
        <div style="margin-top:12px;">
            <table class="ltable"  border="0" width="100%" style="padding-bottom:2px !important">
                ...
                <tr style="font-size: 10px !important; background-color: #D3D3D3;line-height:10px; "> 
                    ...
                    <th width="25%" style="border: 0px; ;border-color: #D3D3D3; text-align: center">USUARIO</th>

                    <th width="23%" style="border: 0px; ;border-color: #D3D3D3; text-align: center">PUESTO</th>
