            ...
            <table class="ltable"  border="0" width="100%" style="padding-bottom:2px !important">
                @foreach($grupos as $key=> $data_resp)
                    <tr style="font-size: 9px !important; background-color: white;line-height:20px; ">                                     
                        <th width="100%" colspan="4" style="border: 0px; text-align: center; line-height:15px">{{$key}}</th>
                    </tr>
                    ...
                    @foreach($data_resp as $e=>$dato)  
                        @foreach($dato as $e1=>$info)  
                            @php
                                ...
                                if($e=="LIQUIDA ACALORICA" || $e=="LIQUIDA ESTRICTA" || $e=="LIQUIDA AMPLIA"){
                                    $color_prof="red";
                                    $cont_liquida_prof=$cont_liquida_prof+1; 
                                }else if($e=="NADA POR VIA ORAL"){
                                    $cont_npo_prof=$cont_npo_prof+1; 
                                    $color_prof="green";
                                }else{
                                    $cont_sin_liquida_prof=$cont_sin_liquida_prof+1; 
                                }
                            @endphp
                        @endforeach
                        ...
                        <tr style="font-size: 7px !important;line-height:5px;   "> 
                            ...
                            <td style="border: 0px; ;border-color: #D3D3D3; text-align: center; line-height:15px; margin-top:15px !important;margin-bottom:1px !important;">  <span style="color:{{$color_prof}}">{{$e}}</span></td>

                            <td style="border: 0px; ;border-color: #D3D3D3; text-align: center; line-height:15px; margin-top:5px !important;margin-bottom:1px !important;"><span style="color:{{$color_prof}}">{{sizeof($dato)}}
                            </td>

                            @if($color_prof=="red"){}
                                <td style="border: 0px; ;border-color: #D3D3D3; text-align: center; line-height:15px; margin-top:5px !important;margin-bottom:1px !important;"><span style="color:{{$color_prof}}">{{sizeof($dato)}}</span></td>
                            @else
                    ...
                    <tfoot>
                        <tr style="font-size:7px !important;line-height:5px" style="">
                            <td style="font-size:7px;border: 0px; border-color: #D3D3D3;  text-align: right;">
                                <b>TOTAL</b>
                            </td>
                            <td style="border: 0px;border-color: #D3D3D3;  text-align: center; font-size:9px">
                                <b>{{$cont_sin_liquida_prof}}</b> 
                                
                            </td>
                            <td style="border: 0px;border-color: #D3D3D3;  text-align: center; font-size:9px">
                                <span style="color:red">{{$cont_liquida_prof}}</span>
                            </td>
    
                            <td style="border: 0px;border-color: #D3D3D3;  text-align: center; font-size:9px">
                                <span style="color:red">{{$cont_npo_prof}}</span>
                            </td>
    
                        </tr>

                        <tr style="font-size:7px !important;line-height:25px" style="">
                            <td colspan="4" style="font-size:8px;border: 0px; border-color: #D3D3D3;  text-align: right;">
