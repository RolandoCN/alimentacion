...
@section('content')
    <section class="content-header">
        <h1>
            Listado de Alimentos por Empleado
        </h1>
        ...
        <div id="content_consulta-" >
            <div class="box ">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        <span id='cabecera_txt'>Reporte Individual</span>
                        ...
                        <div class="col-md-12">
                            <form id="frm_buscarPersona" class="form-horizontal" action="" autocomplete="off">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" id="label_crit" class="col-sm-2 control-label" >Empleado:</label>
                ...
                <div class="box-body" id="listado_turno" style="display:none" >
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <ul class="nav nav-pills nav-stacked"style="margin-left:50px">
                                <li style="border-color: white"><a><i class="fa fa-user text-blue"></i> <b class="text-black" style="font-weight: 650 !important">Empleado</b>: <span  id="usuario_rep"> </span></a></li>
...
{{-- <script src="/js/alimentacion/reporte/usuario_fecha.js"></script> --}}
<script src="{{ asset('js/alimentacion/reporte/usuario_fecha.js?v='.rand())}}"></script>
