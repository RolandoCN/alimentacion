    ...
    <div style="margin-bottom:20px; margin-top:12px;">
        ...
        <table class="ltable" style="" border="0" width="100%" style="padding-bottom:2px !important">
            ...
            <tr style="font-size: 10px"  class="fuenteSubtitulo " style=""> 
                <th colspan="11" style="border-color:white;height:35px;text-align: center;border:0 px" width="100%"  >INFORME DE ALIMENTOS APROBADOS Y NO RETIRADOS  <br> POR RANGO FECHA <br><br>
        ...
        <div style="margin-top:0px;">
            ...
            <table class="ltable"  border="0" width="100%" style="padding-bottom:2px !important">
                <tr style="font-size: 10px !important; background-color: white;line-height:10px; "> 
                    ...
                    <th width="10%" colspan="10" style="border: 0px; ;border-color: white; text-align: center; line-height:10px">RESUMEN GENERAL  DESDE {{date('d-m-Y',strtotime($desde))}} HASTA  {{date('d-m-Y',strtotime($hasta))}}</th>

                </tr>
                <tr style="font-size: 10px !important; background-color: white;line-height:10px; "> 
                    
                    <th width="10%" colspan="10" style="border: 0px; ;border-color: white; text-align: center; line-height:10px"></th>
                ...
                <tr style="font-size: 10px !important; background-color: #D3D3D3;line-height:10px; "> 
                    ...
                    <th width="10%" style="border: 0px; ;border-color: #D3D3D3; text-align: center; line-height:10px">FECHA</th>

                    <th width="10%" style="border: 0px; ;border-color: #D3D3D3; text-align: center">CÉDULA</th>

                    <th width="20%" style="border: 0px; ;border-color: #D3D3D3; text-align: center">USUARIO</th>

                    <th width="23%" style="border: 0px; ;border-color: #D3D3D3; text-align: center">AREA</th>

                    <th width="10%" style="border: 0px; ;border-color: #D3D3D3; text-align: center">IP CONFIRMA</th>
        ...
        <p style="font-size: 10px; text-align:center; font-family:sans-serif;"><b  style="font-size: 10px;">TOTAL PLATOS: {{sizeof($datos)}}</b></p>
        ...
        <div style="margin-top:12px;">
            ...
            <table class="ltable"  border="0" width="100%" style="padding-bottom:2px !important">
                ...
                <tr style="font-size: 10px !important; background-color: white;line-height:10px; "> 
                    ...
                    <th width="10%" colspan="6" style="border: 0px; ;border-color: white; text-align: center; line-height:10px">RESUMEN POR AREA  DESDE {{date('d-m-Y',strtotime($desde))}} HASTA  {{date('d-m-Y',strtotime($hasta))}}</th>
                ...
                <tr style="font-size: 10px !important; background-color: #D3D3D3;line-height:10px; "> 
                    ...
                    <th width="10%" style="border: 0px; ;border-color: #D3D3D3; text-align: center; line-height:10px">AREA</th>
